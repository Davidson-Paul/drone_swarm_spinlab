...
class DroneController:
    def __init__(self):
        # Initialize ROS node
        rospy.init_node('controller_F2_local')
        ...
        rospy.Subscriber('/fury_1/drone_states',DroneStates_local,self.leader_states_callback)
        ...
        rospy.Subscriber('fury_1/mavros/home_position/home', HomePosition, self.leader_home_position_callback)
        rospy.Subscriber('fury_2/mavros/home_position/home', HomePosition, self.follower_home_position_callback)

        # Wait for topics to become available
        rospy.wait_for_message('fury_1/mavros/home_position/home', HomePosition)
        rospy.wait_for_message('fury_2/mavros/home_position/home', HomePosition)
