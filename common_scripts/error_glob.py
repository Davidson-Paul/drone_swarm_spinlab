...
#Script for plotting the spacing of the drones wrt the leader
...
class DistanceCollector:
    ...
    def update_plot(self, frame):
        ...
        distance12 = self.get_distance(self.position1, self.position2)
        distance13 = self.get_distance(self.position1, self.position3)
        distance14 = self.get_distance(self.position1, self.position4)
        distance15 = self.get_distance(self.position1, self.position5)
